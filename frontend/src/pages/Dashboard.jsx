...
export default function Dashboard() {
  ...
  return <div className="dashboard">
    ...
    <div className="video-feature-card"><div><span className="eyebrow">NEW</span><h2>Notes → Video</h2><p>Turn your PPT, PDF or TXT notes into a narrated learning video.</p></div><Link className="btn" to="/notes-to-video">Create video →</Link></div>
